...
TheOutHaven now maintains a two-migration production baseline in `supabase/migrations/`:
...
- Keep `supabase/migrations/` limited to the two baseline migrations plus migrations created after that baseline pair.

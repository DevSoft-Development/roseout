    ...
    <main className="space-y-6 p-4 sm:p-6">
      <div className="flex flex-wrap items-end justify-between gap-3">
        ...
        <div className="flex gap-2">
          {item.approval_status === "pending" ? <Link href={`/admin/dashboard/marketing/content/${item.id}/review`} className="min-h-11 rounded-xl bg-neutral-950 px-4 py-2.5 text-sm font-semibold text-white">Open review</Link> : null}

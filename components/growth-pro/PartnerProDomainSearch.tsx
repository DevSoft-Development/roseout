  ...
  return (
    <div className="space-y-5">
      <section className="rounded-3xl border border-rose-200/15 bg-white/[0.04] p-6">
        ...
        <p className="mt-2 text-sm leading-6 text-white/65">Choose one eligible standard domain for your location. Your first year of registration is included with Partner Pro. Renewal after the first year is not included.</p>

...
export default async function TicketOrdersPage({ searchParams }: { searchParams: Params }) {
  ...
  return <AdminPageShell>
      <AdminPageHeader
        ...
        title="Ticket Orders"
        subtitle="Unified operational ledger for Event ticket orders and Experience bookings. Stripe remains the payment source of truth."
      ...
      <AdminKpiGrid>
        ...
        <AdminKpiCard label="Platform fees" value={money(fees)} helper="Recorded platform fees" />

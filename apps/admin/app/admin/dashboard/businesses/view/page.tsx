...
export default async function BusinessViewPage({ searchParams }: { searchParams: Promise<{ q?: string; locationId?: string }> }) {
  const currentAdmin = await requireAdminRole(["superadmin", "admin", "manager", "editor", "reviewer", "ambassador", "experience_team", "viewer"]);

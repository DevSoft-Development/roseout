...
function getWhyPicked({
  ...
  const fallbackReasons =
    type === "restaurant"
      ? [
          `Strong ${titleCase(eyebrow || "dining").toLowerCase()} match for this search.`,
          "Good fit for the requested food style and area.",
          "Balanced pick for cuisine, vibe, and outing flow.",
        ]
      : [
          `Works well as the next stop after dinner.`,
          "Adds a nearby experience that fits the night.",
          "Rounds out the plan with a compatible activity.",
        ];

...
insert into public.support_triggers (key,name,category_contains,target_group,sort_order) values
 ('billing','Billing tickets','billing','billing',10),
 ('reservations','Reservation tickets','reservation','reservations',20),
 ('technical','Technical tickets','technical','technical_support',30),
 ('website','Website tickets','website','technical_support',40),
 ('domain','Domain tickets','domain','technical_support',50),
 ('bug','Bug reports','bug','technical_support',60)

...
import LocationEditorPhotosPanel from "./LocationEditorPhotosPanel";
import { buildLocationEditorContext, toSelectedLocationRequestContext } from "./location-editor-context";
...
export default function CleanLocationEditor() {
  ...
  async function saveLocation() {
    ...
    try {
      const res = await fetch("/api/locations/edit-context", { method: "PATCH", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ ...toSelectedLocationRequestContext(editorContext), type: table, id: canonicalId || effectiveId || locationId, payload }) });
      const result = await res.json();

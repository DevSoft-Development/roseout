...
export default function GuidedResultsPageV4() {
  ...
  useEffect(() => {
    ...
    const disablePersonalization = sessionStorage.getItem("theouthaven_search_without_personalization") === "1";
    if (disablePersonalization) sessionStorage.removeItem("theouthaven_search_without_personalization");

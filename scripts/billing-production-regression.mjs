...
const checks = [
  ...
  ['organizer Connect return uses synchronized account state', organizerOnboard, /api\/organizers\/stripe-connect\/return/, organizerReturn, /retrieveConnectAccountState/, /connectStateUpdate/, connectStatus, /stripe_connect_charges_enabled/, /stripe_connect_payouts_enabled/],

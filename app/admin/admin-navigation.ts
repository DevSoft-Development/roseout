...
export const adminNavSections: readonly AdminNavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Organization Verification", href: "/admin/dashboard/trust/organization-verification", icon: Building2, permission: "claims" },
      { label: "Organizer Verification", href: "/admin/dashboard/trust/organizer-verification", icon: UserCheck, permission: "claims" },

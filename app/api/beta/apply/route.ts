...
export async function POST(request: NextRequest) {
  try {
    ...
    void sendRawBrandedEmail({ to: "admin@theouthaven.com", department: "support", subject: "New TheOutHaven beta application", heading: "New beta application", body: `${name} (${email}) applied to test as ${body.tester_type || "user"}.` });

...
describe("reservation email layout", () => {
  it("renders customer confirmations as a reservation-first branded email", () => {
    const rendered = renderStructuredReservationRawEmail({
      subject: "Your TheOutHaven Lounge reservation:",
      body: "TheOutHaven Reserve Hi Nick, your reservation at TheOutHaven Lounge has been confirmed. Date: 2026-08-14 Time: 8:00 PM Party Size: 2 Reserved: Bar Seats View / Manage Reservation Use this link to view your reservation or cancel if needed. Thank you for using TheOutHaven.",
    });
    ...
    expect(rendered?.html).toContain("2026-08-14");

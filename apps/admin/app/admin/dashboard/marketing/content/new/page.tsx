  ...
  return (
    <AdminPageShell>
      <AdminPageHeader
        ...
        badge={<AdminStatusBadge tone="blue">Approval required before publish</AdminStatusBadge>}
        actions={<AdminActionButton href="/admin/dashboard/marketing/content">Back to Pipeline</AdminActionButton>}
      />

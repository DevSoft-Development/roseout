...
requireText('admin) verify_admin_callback ;;', 'Admin-only cutover must validate only the Admin callback boundary.');
requireText('business) verify_business_callback ;;', 'Business-only cutover must validate only the Business callback boundary.');
requireText('both) verify_admin_callback; verify_business_callback ;;', 'Both-surface cutover must validate both callback boundaries.');

...
-- Search lifecycle events are not tied to a specific location/item. These
-- columns are retained for backwards compatibility with legacy analytics
-- writers, but they must be optional for the canonical event pipeline.

...
export const adminNavSections: readonly AdminNavSection[] = [
  ...
  { label: "Marketing", icon: Megaphone, items: [
    { label: "Overview", href: "/admin/dashboard/marketing", icon: Home, permission: "marketing" }, { label: "AI Social Manager", href: "/admin/dashboard/marketing/social-manager", icon: Megaphone, permission: "marketing" }, { label: "Today", href: "/admin/dashboard/marketing/today", icon: ListTodo, permission: "marketing" }, { label: "Community", href: "/admin/dashboard/marketing/community", icon: MessageSquare, permission: "marketing" }, { label: "Growth", href: "/admin/dashboard/marketing/growth", icon: LineChart, permission: "marketing" }, { label: "Creators", href: "/admin/dashboard/marketing/creators", icon: Users, permission: "marketing" }, { label: "Discover", href: "/admin/dashboard/marketing/discover", icon: Compass, permission: "marketing" }, { label: "Sponsored Promotions", href: "/admin/dashboard/marketing/promotions", icon: CircleDollarSign, permission: "marketing" }, { label: "Reports", href: "/admin/dashboard/marketing/reports", icon: BarChart3, permission: "marketing" }, { label: "SEO Center", href: "/admin/dashboard/seo", icon: SearchCheck, permission: "seoTools" }, { label: "Content", href: "/admin/dashboard/marketing/content", icon: Megaphone, permission: "marketing" }, { label: "Content Opportunities", href: "/admin/dashboard/marketing/opportunities", icon: Lightbulb, permission: "marketing" }, { label: "Calendar", href: "/admin/dashboard/marketing/calendar", icon: CalendarDays, permission: "marketing" }, { label: "Media", href: "/admin/dashboard/marketing/media", icon: Image, permission: "marketing" }, { label: "Approvals", href: "/admin/dashboard/marketing/approvals", icon: ClipboardCheck, permission: "marketing" }, { label: "Social Accounts", href: "/admin/dashboard/marketing/social-accounts", icon: Network, permission: "marketingSocialAccounts" }, { label: "Settings", href: "/admin/dashboard/marketing/settings", icon: Settings, permission: "marketing" },
  ] },

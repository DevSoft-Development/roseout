...
export async function GET(request: Request) {
  ...
  if (authAdminRedirect) {
    return Response.json({ redirectPath: authAdminRedirect });
  }
  ...
  if (email) {
    ...
    if (adminRedirect) {
      return Response.json({ redirectPath: adminRedirect });
    }
  }
  ...
  if (profileAdminRedirect) {
    return Response.json({ redirectPath: profileAdminRedirect });
  }

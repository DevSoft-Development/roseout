...
export function buildLocationEditorLinks({
  ...
  return {
    ...
    reserveDashboard: withDashboardContext("https://reserve.theouthaven.com/reserve/dashboard"),
    reservations: withDashboardContext("https://reserve.theouthaven.com/reserve/dashboard?tab=reservations"),
    reservationLayout: withDashboardContext("https://reserve.theouthaven.com/reserve/dashboard?tab=settings&section=layout"),

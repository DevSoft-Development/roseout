...
import { isSponsoredPlacement, sponsoredAttribution, sponsoredLabel } from "../sponsored-placement";
describe("sponsored placement disclosure", () => {
  ...
  it("preserves sponsor and campaign attribution", () => {
    expect(sponsoredAttribution({ sponsored: true, sponsor_id: 12, campaign_id: "c1" })).toEqual({
      sponsored: true, placementType: "sponsored", sponsorId: "12", campaignId: "c1",
    });
  });
});

...
-- Staging cleanup skipped intentionally.
-- Optional location_import_staging backfill removed because older deployments have different staging schemas.
-- This does not affect Edge Functions.



-- admin_low_level_location_summary skipped intentionally.
-- This optional reporting view can be recreated later after the low-level cleanup schema is stable.
-- This does not affect Edge Functions.

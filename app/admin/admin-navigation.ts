...
export const adminNavSections: readonly AdminNavSection[] = [
  ...
  { label: "Marketing", icon: Megaphone, items: [
    ...
    { label: "Reports", href: "/admin/dashboard/marketing/reports", icon: BarChart3, permission: "marketing" },
    { label: "Audience & Search", href: "/admin/dashboard/marketing/audience", icon: SearchCheck, permission: "marketing" },
    { label: "Locations & Neighborhoods", href: "/admin/dashboard/marketing/locations", icon: MapPin, permission: "marketing" },
    { label: "Search Funnel", href: "/admin/dashboard/marketing/funnel", icon: LineChart, permission: "marketing" },
    { label: "Acquisition", href: "/admin/dashboard/marketing/acquisition", icon: Network, permission: "marketing" },
    ...
    { label: "Social Accounts", href: "/admin/dashboard/marketing/social-accounts", icon: Network, permission: "marketingSocialAccounts" },
    { label: "Settings", href: "/admin/dashboard/marketing/settings", icon: Settings, permission: "marketing" },
  ] },
  ...
  { label: "Operations", icon: Wrench, items: [
    ...
    { label: "Platform Errors", href: "/admin/dashboard/platform-errors", icon: ShieldAlert, permission: "logs" },

...
export const metadata = {
  ...
  description: "Monitor technical failures and search-quality issues.",
};
      ...
      <div className="mx-auto max-w-[1500px] space-y-5">
        <section className="rounded-3xl border border-white/10 bg-[radial-gradient(circle_at_top_left,rgba(225,29,72,0.14),transparent_30%),linear-gradient(135deg,#170b0b,#090706_58%,#14100c)] p-6">
          ...
          <p className="mt-3 max-w-3xl text-sm leading-6 text-white/65">
            Monitor technical failures, relevance problems, audience-safety mismatches, domain and geography errors, pairing failures, and slow searches.
          </p>

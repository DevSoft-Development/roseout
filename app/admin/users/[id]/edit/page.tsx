...
function editErrorRedirect(userId: string, message: string) {
          ...
          <div className="relative z-10 flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
            <div>
              ...
              <p className="mt-3 text-sm text-white/60">
                Update account profile, access role, subscription, Stripe IDs, and password.
              </p>
            </div>
          ...
          <form action={updateUser} className="grid gap-5 p-5">
            ...
            <div className="grid gap-5 md:grid-cols-2">
              ...
              <Field
                ...
                placeholder="free, active, canceled..."
              />
              <Field
            ...
            <div className="rounded-2xl border border-rose-200 bg-rose-50 p-4 text-sm font-bold text-rose-800">
              Superusers can edit all account fields here. Leave the password field blank unless
              you want to reset this user&apos;s login password.
            </div>

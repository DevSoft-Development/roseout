...
export function buildLocationEditorLinks({
  ...
  return {
    ...
    qrTools: withDashboardContext(`/locations/${type}/${locationId}/edit#qr-codes`),
    ...
    menuEditor: withDashboardContext(`/locations/${type}/${locationId}/edit#menu`),
    menuViewer: withContext(`/locations/${type}/${publicId}/menu`),
    photos: withDashboardContext("/business/dashboard/profile"),
    analytics: withDashboardContext(`/locations/${type}/${locationId}/edit#analytics`),

...
export type SearchPlan = Readonly<{
  ...
  geo: Readonly<{ source: "explicit" | "zip" | "current_location" | "anchor" | "default_market"; zipCode?: string | null; market: string | null; city: string | null; borough: string | null; neighborhood: string | null; county: string | null; state: string | null; latitude: number | null; longitude: number | null; radiusMiles: number; strictness: "strict" | "preferred" | "broad" }>;
...
export type SearchPlannerInput = {
  ...
  resolvedGeo?: { zipCode?: string | null; neighborhood?: string | null; borough?: string | null; city?: string | null; county?: string | null; state?: string | null; market?: string | null; latitude?: number | null; longitude?: number | null; radiusMiles?: number | null; source?: "zip" | "explicit" } | null;
  market?: string | null;

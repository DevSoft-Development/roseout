...
export const metadata: Metadata = buildMetadata({
  ...
  description:
    "TheOutHaven helps people plan restaurants, activities, lounges, date plans, birthdays, brunches, celebrations, and full outings across NYC, Long Island, Northern New Jersey, and Connecticut.",
  path: "/",
});
...
const occasionCards = [
  {
    icon: "♡",
    title: "Date Plans",
    description: "Great food, atmosphere, and something memorable after.",
    prompt: "romantic restaurant and something fun after",
  },
  {
    icon: "✦",
    title: "Birthday Plans",
    description: "Celebration-ready places with room for the next stop.",
    prompt: "birthday meal with a lounge or activity",
  },
  {
    icon: "✨",
    title: "Friends’ Plans",
  ...
  },
  {
    icon: "⌁",
    title: "Rooftop Plans",
    description: "Views, drinks, bites, and a more elevated mood.",
    prompt: "rooftop drinks or bites with a view",
  },
  {
    icon: "◐",
    title: "Food + Hookah",
    description: "Start with food, then keep the outing relaxed nearby.",
    prompt: "steakhouse and hookah lounge nearby",
  },
  {
    icon: "◆",
  ...
  },
  {
    ...
    prompt: "casual food and relaxed activity",
  },
];

const searchExamples = [
  "steakhouse and hookah in Queens",
  "romantic rooftop spot in Manhattan",
  "birthday meal with activities",
      ...
      <div className="space-y-7">
        ...
        <div className="space-y-5">
          ...
          <p className="max-w-2xl text-lg leading-8 text-white/70 sm:text-xl">
            Find restaurants, lounges, rooftops, activities, brunch spots, and experiences matched by vibe, area, occasion, and what you want to do next.
          </p>
        </div>
        ...
        <div className="rounded-[2rem] border border-white/10 bg-black/35 p-4 shadow-2xl shadow-black/30 backdrop-blur sm:p-5">
          <form action="/create" method="get" className="flex flex-col gap-3 sm:flex-row">
            <input
              type="text"
              name="prompt"
              placeholder="Try: steakhouse and hookah in Queens"
    ...
    <aside className="relative overflow-hidden rounded-[2rem] border border-white/10 bg-white/[0.04] p-5 shadow-2xl shadow-black/40 sm:p-6 lg:ml-auto lg:max-w-[34rem]">
      ...
      <div className="relative rounded-[1.5rem] border border-white/10 bg-black/35 p-5 backdrop-blur">
        ...
        <h2 className="mt-3 max-w-sm text-3xl font-black tracking-tight text-white sm:text-4xl">
          Start with a great place, then keep the plan going
        </h2>
      ...
      <div className="mb-6 flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
        <div>
          ...
          <p className="mt-2 max-w-3xl text-sm leading-6 text-white/65">
            Start with the moment. TheOutHaven helps shape the place, the next stop, and the overall vibe.
          </p>
        </div>
      </div>
  ...
  return (
    <section className="rounded-[2rem] border border-white/10 bg-white/[0.035] p-6 shadow-2xl shadow-black/25 sm:p-8">
      <div className="mb-6">
        ...
        <p className="mt-2 max-w-3xl text-sm leading-6 text-white/65">
          Made for complete outings — the first stop, the next stop, and the mood around it.
        </p>
      </div>
...
function FeaturedPlaces({ locations }: { locations: HomeLocation[] }) {
  return (
    <section>
      <div className="mb-6">
        <h2 className="text-3xl font-black tracking-tight sm:text-4xl">Outing-worthy places</h2>
        <p className="mt-2 max-w-3xl text-sm leading-6 text-white/65">
          A rotating mix of restaurants, activities, lounges, and outing-friendly spots to inspire your next plan.
        </p>
      </div>
      {locations.length ? (
        <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
        ...
        <div className="rounded-[1.5rem] border border-white/10 bg-white/[0.035] p-6 text-sm leading-6 text-white/65">
          Fresh outing-worthy places are being curated. Start with a prompt and we’ll help build the plan.
        </div>
      )}
    </section>
  );
  ...
  return (
    <section className="rounded-[2rem] border border-white/10 bg-[radial-gradient(circle_at_20%_20%,rgba(225,6,42,.30),transparent_40%),linear-gradient(135deg,#180807,#080303)] p-6 shadow-2xl shadow-black/25 sm:p-8 lg:p-10">
      ...
      <p className="mt-3 max-w-3xl text-sm leading-7 text-white/70 sm:text-base">
        Describe the experience you want — the food, the area, the occasion, or the thing you want to do after — and TheOutHaven will help turn it into a plan.
      </p>
      <div className="mt-6">
        <Link
          href="/create"
    ...
    <section className="overflow-hidden rounded-[2rem] border border-white/10 bg-[linear-gradient(135deg,rgba(255,255,255,.075),rgba(255,255,255,.025))] p-6 shadow-2xl shadow-black/25 sm:p-8 lg:p-10">
      <div className="grid gap-8 lg:grid-cols-[1fr_auto] lg:items-center">
        <div>
          ...
          <p className="mt-3 max-w-3xl text-sm leading-7 text-white/70 sm:text-base">
            Get discovered by people planning date plans, birthdays, group outings, weekend plans, and full experiences near you.
          </p>
        </div>

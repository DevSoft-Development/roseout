...
export default async function CareersOffersPage() {
  ...
  return (
    <AdminPageShell>
      <AdminPageHeader
        eyebrow="Careers CRM · Offers"
        title="Offer Tracking"
        subtitle="Review pending, sent, accepted, declined, expired, and withdrawn offers."
        badge={<AdminStatusBadge tone={rows.length ? "blue" : "muted"}>{rows.length} offers</AdminStatusBadge>}

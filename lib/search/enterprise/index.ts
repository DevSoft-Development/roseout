...
export async function runEnterpriseSearch(
  ...
  try {
    ...
    const response: EnterpriseSearchResult = {
      ...
      duplicateLocationShown: duplicateLocationHealth.duplicateLocationShown,
      duplicateLocationCount: duplicateLocationHealth.duplicateLocationCount,
      duplicateLocationErrors: duplicateLocationHealth.duplicateLocationErrors,
      duplicateLocationWarnings: duplicateLocationHealth.duplicateLocationWarnings,
      duplicateLocationKeys: duplicateLocationHealth.duplicateLocationKeys,
      debug: responseDebug,
    };

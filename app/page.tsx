...
const TODAY_HOME_BADGE = "May 11 live update • route-first homepage";
    ...
    >
      ...
      <section className="relative isolate overflow-hidden px-5 pb-16 pt-32 sm:px-6 lg:pb-24 lg:pt-40">
        ...
        <div className="mx-auto grid max-w-7xl items-center gap-12 lg:grid-cols-[0.98fr_1.02fr]">
          <div>
            <p className="inline-flex rounded-full border border-[#e1062a]/35 bg-[#e1062a]/15 px-4 py-2 text-xs font-black uppercase tracking-[0.24em] text-red-100 shadow-2xl shadow-red-950/30">
              {TODAY_HOME_BADGE}
            </p>
            <h1 className="mt-7 max-w-5xl text-5xl font-black leading-[0.88] tracking-[-0.065em] text-white sm:text-7xl lg:text-8xl">
              Build the full route, not just a list of places.
            </h1>
            <p className="mt-6 max-w-2xl text-lg leading-8 text-white/68 sm:text-xl">
              Today&apos;s TheOutHaven homepage now highlights restaurant anchors,
              dessert and activity add-ons, and walking-distance context in one
              clean planning flow.
            </p>
            <div className="mt-9 flex flex-col gap-4 sm:flex-row sm:items-center">
              <Link
                href="/create"
                className="inline-flex items-center justify-center rounded-full bg-[#e1062a] px-9 py-5 text-base font-black text-white shadow-2xl shadow-red-950/40 transition hover:-translate-y-0.5 hover:bg-red-500"
              >
                Plan My Outing
              </Link>
              <p className="text-sm font-bold text-white/48">
                Restaurant → add-on → activity, clearly connected.
              </p>
            </div>
          </div>
      ...
      <section className="bg-[#fff8f1] px-5 py-16 text-[#17110f] sm:px-6 lg:py-20">
        <div className="mx-auto max-w-7xl">
          <SectionIntro
            eyebrow="Today's planning lanes"
            title="The homepage now points people to complete outings."
      ...
      <section className="border-y border-white/10 bg-[#110808] px-5 py-16 text-white sm:px-6 lg:py-20">
        <div className="mx-auto max-w-7xl">
          <SectionIntro
            eyebrow="Quick-start categories"
          ...
          <div className="mt-10 grid grid-cols-2 gap-3 sm:grid-cols-4 lg:grid-cols-8">
            {categories.map((category) => (
              <Link
                ...
                className="group rounded-3xl border border-white/10 bg-white/[0.06] p-4 text-center transition hover:-translate-y-1 hover:border-[#e1062a]/55 hover:bg-[#e1062a]/15"
              >
      ...
      <section className="bg-[#fff8f1] px-5 pb-16 text-[#17110f] sm:px-6 lg:pb-24">
        <div className="mx-auto max-w-7xl overflow-hidden rounded-[2.5rem] bg-[#e1062a] px-6 py-16 text-center text-white shadow-2xl shadow-red-950/20 sm:px-10 lg:py-20">
          ...
          <h2 className="mx-auto mt-4 max-w-3xl text-4xl font-black leading-none tracking-[-0.05em] sm:text-6xl">
            Today&apos;s route-first homepage is live.
          </h2>
...
function HeroPlanCard() {
  return (
    <div className="relative rounded-[2.35rem] border border-white/15 bg-white/10 p-4 shadow-2xl shadow-black/40 backdrop-blur">
      <div className="absolute -right-4 -top-4 hidden rounded-3xl bg-[#e1062a] px-5 py-4 text-sm font-black text-white shadow-xl shadow-red-950/35 sm:block">
        Today&apos;s route
      </div>
      <div className="rounded-[1.85rem] border border-white/10 bg-[#120909] p-5 text-white">
        <div className="flex items-start justify-between gap-4">
          ...
          <span className="rounded-full bg-[#e1062a]/20 px-3 py-1 text-xs font-black text-red-100">
            May 11
          </span>
        </div>

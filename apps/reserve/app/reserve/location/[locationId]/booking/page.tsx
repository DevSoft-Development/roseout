                ...
                <form onSubmit={submit} className="mt-7 space-y-5">
                  ...
                  <div className={showSeatingPreference ? "border-t border-white/10 pt-5" : ""}>
                    ...
                    <div className="mt-4 rounded-2xl border border-white/10 bg-black/35 p-4">
                      ...
                      <p className="mt-2 pl-7 text-[11px] leading-5 text-white/40">See our <Link href="/sms-terms" target="_blank" className="font-bold text-red-300 underline underline-offset-2">SMS Terms</Link> and <Link href="/privacy" target="_blank" className="font-bold text-red-300 underline underline-offset-2">Privacy Policy</Link>.</p>

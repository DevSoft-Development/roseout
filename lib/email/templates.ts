...
function defaultsFor(key: string): TemplateDefaults {
  ...
  if (key.startsWith("career_")) { group = "careers"; senderKey = "support"; department = "support"; recipientType = "user"; variant = "customer"; cta = "View Application"; }
...
"user_email_verification","user_password_reset","user_welcome","user_signup_confirmation","user_outing_saved","user_outing_reminder","user_outing_completed_feedback","user_offer_claim_confirmation","user_vip_signup_confirmation","user_event_lead_confirmation","user_event_proposal_ready","user_event_contract_ready","user_private_feedback_thank_you","user_review_invitation_verified","user_review_submitted","user_support_ticket_created","user_support_ticket_updated",
...
"password_setup_invite","password_reset","email_verification","login_code","suspicious_login_alert",
"career_application_received","career_application_under_review","career_interview_requested","career_interview_scheduled","career_interview_reminder","career_interview_rescheduled","career_not_selected","career_offer_sent","career_offer_accepted","career_offer_declined","career_hired_welcome","career_talent_pool_followup","career_content_test_requested","career_internship_started","career_internship_completed"] as const;

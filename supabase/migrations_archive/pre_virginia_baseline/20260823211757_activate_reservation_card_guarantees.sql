...
drop trigger if exists location_reservations_apply_guarantee_snapshot on public.location_reservations;
create trigger location_reservations_apply_guarantee_snapshot
before insert on public.location_reservations
for each row
execute function public.apply_reservation_guarantee_snapshot();

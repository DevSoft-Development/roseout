...
export const restaurants: FixtureLocation[] = [
  ...
  restaurant({ id: "bk-brunch", name: "Brooklyn Brunch House", city: "New York", borough: "Brooklyn", county: "Kings County", latitude: 40.684, longitude: -73.977, cuisine: "American brunch", primary_category: "brunch restaurant", tags: ["brunch", "eggs", "mimosas", "Brooklyn"], description: "Full-service brunch restaurant in Brooklyn for fun dates and weekend outings." }),
  restaurant({ id: "bk-cafe", name: "Williamsburg Brunch Cafe", city: "New York", borough: "Brooklyn", county: "Kings County", latitude: 40.714, longitude: -73.961, cuisine: "Cafe brunch", primary_category: "brunch cafe restaurant", tags: ["brunch", "cafe", "Brooklyn"], description: "Brooklyn brunch cafe near Williamsburg activities." }),
];
...
export const activities: FixtureLocation[] = [
  ...
  activity({ id: "bk-bowl", name: "Brooklyn Bowl", city: "New York", borough: "Brooklyn", county: "Kings County", latitude: 40.7219, longitude: -73.9575, primary_category: "bowling alley", activity_type: "bowling", tags: ["bowling", "games", "fun activity", "Brooklyn"], description: "Bowling, games, and live entertainment in Brooklyn." }),
  activity({ id: "bk-museum", name: "Brooklyn Museum", city: "New York", borough: "Brooklyn", county: "Kings County", latitude: 40.6712, longitude: -73.9636, primary_category: "museum", activity_type: "museum", tags: ["museum", "gallery", "art", "fun activity", "Brooklyn"], description: "Brooklyn museum and gallery activity for dates and outings." }),
  activity({ id: "bk-arcade", name: "Brooklyn Arcade Lounge", city: "New York", borough: "Brooklyn", county: "Kings County", latitude: 40.6782, longitude: -73.9442, primary_category: "arcade lounge", activity_type: "arcade", tags: ["arcade", "games", "lounge", "fun activity", "Brooklyn"], description: "Arcade games and lounge in Brooklyn for something fun." }),
];

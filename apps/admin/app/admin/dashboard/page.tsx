...
export default async function CentralDashboardPage() {
  ...
  return (
    <AdminPageShell>
      <AdminPageHeader
        eyebrow="TheOutHaven · Administration"
        title="Admin Overview"
        subtitle="Monitor operations, partners, search health, claims, websites, infrastructure, and growth from one control plane."
        badge={<AdminStatusBadge tone={openTickets ? "amber" : "green"}>{openTickets ? `${format(openTickets)} open tickets` : "Operations healthy"}</AdminStatusBadge>}
        actions={<><AdminActionButton href="/admin/dashboard/website-hosting">Website Hosting</AdminActionButton><AdminActionButton href="/admin/dashboard/reports">Reports</AdminActionButton><AdminActionButton href="/admin/dashboard/settings" variant="primary">Settings</AdminActionButton></>}
      />

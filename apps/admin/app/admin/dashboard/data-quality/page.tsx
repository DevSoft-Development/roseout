  ...
  return (
    <section className="data-quality-page">
      <header className="data-quality-hero">
        ...
        <span>
          Start with the queues that determine whether a location can safely appear in customer search.
        </span>
      </header>
      ...
      <section className="data-quality-standard">
        ...
        <p>
          ...
          Use the decision queues first and the advanced tools only for deeper operational work.
        </p>
      </section>

      <details className="data-quality-advanced">
        <summary>Advanced location operations</summary>
        <div>

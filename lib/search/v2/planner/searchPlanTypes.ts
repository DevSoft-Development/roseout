...
export type SearchPlan = Readonly<{
  ...
  geo: Readonly<{ source: "explicit" | "current_location" | "anchor" | "default_market"; market: string | null; city: string | null; borough: string | null; neighborhood: string | null; county: string | null; state: string | null; latitude: number | null; longitude: number | null; radiusMiles: number; strictness: "strict" | "preferred" | "broad"; exclusions?: readonly string[] }>;

...
function normalizeApiCards(data: ApiResponse) {
  const restaurants = Array.isArray(data.restaurants)
    ? data.restaurants.filter(hasLocationImage)
    : [];
  const activities = Array.isArray(data.activities)
    ? data.activities.filter(hasLocationImage)
    : [];
  const cards = Array.isArray(data.cards)
    ? data.cards.filter(hasLocationImage)
    : [];
  const matched = Array.isArray(data.matched_locations)
    ? data.matched_locations.filter(hasLocationImage)
    : [];

...
export default async function TicketOrdersPage({ searchParams }: { searchParams: Params }) {
  ...
  return <div className="min-h-screen bg-[#050607] p-5 text-white lg:p-8">
    <div className="mx-auto max-w-[1500px] space-y-6">
      <div className="flex flex-wrap items-end justify-between gap-4"><div><p className="text-xs font-black uppercase tracking-[.2em] text-[#ff6b86]">Commerce</p><h1 className="mt-2 text-3xl font-black">Ticket Orders</h1><p className="mt-2 max-w-3xl text-sm text-white/55">Unified operational ledger for Event ticket orders and Experience bookings. Stripe remains the payment source of truth; this workspace reflects fulfillment, delivery, payment and check-in state.</p></div><Link href="/admin/dashboard" className="rounded-xl border border-white/10 bg-white/[.05] px-4 py-3 text-sm font-bold">Back to dashboard</Link></div>

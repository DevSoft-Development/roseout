...
const RESERVATION_INTENT = /\b(my\s+)?(reservation|booking|table|waitlist)\b|\b(cancel|change|move|reschedule|modify)\b.{0,40}\b(reservation|booking|table|time|date|party\s*size)\b|\b(reservation|booking)\b.{0,40}\b(cancel|change|move|reschedule|modify|confirmation|details)\b/i;

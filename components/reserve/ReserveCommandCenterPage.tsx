...
function ReserveCommandCenterContent() {
  ...
  async function assignResource(reservation:Reservation, resource:any){
    ...
    try {
      ...
      setSelectedId(reservation.id); setAssigningReservationId(""); setAssignmentDiagnostics(null); setMessage({ tone:"success", text:`${vocab.resource} assigned. You can continue.` });

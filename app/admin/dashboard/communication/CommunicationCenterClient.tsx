  ...
  return (
    <main className="min-h-screen bg-[#090706] px-4 py-8 text-white sm:px-6 lg:px-8">
      <div className="mx-auto max-w-7xl space-y-6">
        <section className="rounded-[1.5rem] border border-white/10 bg-[#120d0b] p-6 shadow-2xl"><h1 className="text-3xl font-black">Communication Center</h1><p className="text-white/70">Search users, locations, send messages, and manage support conversations.</p></section>

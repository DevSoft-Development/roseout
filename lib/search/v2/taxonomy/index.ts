...
export const canonicalTaxonomy: readonly CanonicalTaxonomyEntry[] = [
  ...
  entry("sports_bar", "restaurant_category", ["sports bar", "sports pub"]),
  ...
  entry("indoor_playground", "activity", ["indoor playground", "play center", "kids play", "catch air", "kidville", "wonderland"]),
  ...
  entry("rooftop", "feature", ["rooftop", "roof deck"]), entry("cocktails", "feature", ["cocktails", "craft cocktails", "serves alcohol"]), entry("big_screens", "feature", ["big screens", "watch the game"]), entry("family_friendly", "feature", ["family friendly", "family-friendly"]), entry("casual", "feature", ["casual", "laid-back", "low-key"]), entry("outdoor_seating", "feature", ["outdoor seating", "patio"]),

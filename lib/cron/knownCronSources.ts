...
export const knownCronSources: KnownCronSource[] = [
  ...
  { job_key: "beta-tester-reminders", source: "edge_function", route_path: "supabase/functions/beta-tester-reminders", schedule_detected: true, schedule_hint: "pg_cron: 0 14 * * 1-5", logger_expected: true, notes: "Scheduled in supabase/sql/setup-edge-function-crons.sql." },
  ...
  { job_key: "team-session-watchdog", source: "edge_function", route_path: "supabase/functions/team-session-watchdog", schedule_detected: true, schedule_hint: "pg_cron: */30 * * * *", logger_expected: true, notes: "Scheduled in supabase/sql/setup-edge-function-crons.sql." },

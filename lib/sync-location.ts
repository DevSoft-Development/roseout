...
export function buildLocationPayload(table: SourceTable, row: SourceRow) {
  ...
  const payload: Record<string, unknown> = {
    ...
    reservation_url: firstPresent<string>(row.reservation_url, row.booking_url, row.reservation_link),
    booking_url: firstPresent<string>(row.booking_url, row.reservation_url),
    reservation_link: firstPresent<string>(row.reservation_link, row.reservation_url),

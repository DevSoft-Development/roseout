...
const runtimeProvider = process.env.PLATFORM_RUNTIME_PROVIDER;
const isAwsBackground = runtimeProvider === "aws-background";
const isAwsRuntime = runtimeProvider === "aws-background" || runtimeProvider === "aws-dr";

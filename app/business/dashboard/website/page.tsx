...
import { WebsitePublishControl } from "@/components/websites/WebsitePublishControl";
...
export default async function Page() {
  ...
  return <GrowthProShell title="AI Website Builder"><div className="space-y-5">
    ...
    <WebsitePublishControl locationId={location.id} />
    <WebsiteVersionHistory locationId={location.id} />

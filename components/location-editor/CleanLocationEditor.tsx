...
type FormState = {
  ...
  cuisine: string; activity_type: string; price_range: string; primary_tag: string; search_keywords: string; latitude: string | number; longitude: string | number; google_place_id: string; formatted_address: string;
};
...
function toArray(value: string) { return value ? value.split(",").map((item) => item.trim()).filter(Boolean) : []; }
    ...
    async function loadLocation() {
      ...
      try {
        ...
        const nextForm: FormState = {
          ...
          cuisine: data.cuisine || "", activity_type: data.activity_type || "", price_range: data.price_range || "", primary_tag: data.primary_tag || "", search_keywords: Array.isArray(data.search_keywords) ? data.search_keywords.join(", ") : data.search_keywords || "",

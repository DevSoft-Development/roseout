...
export default async function CareersInternshipsPage() {
  ...
  return (
    <AdminPageShell>
      <AdminPageHeader
        eyebrow="Careers CRM · Programs"
        title="Internship Programs"
        subtitle="Track paid, educational, college-credit, social, campus, and creator programs."
        badge={<AdminStatusBadge tone={rows.length ? "blue" : "muted"}>{rows.length} programs</AdminStatusBadge>}

...
export default function CleanLocationEditor() {
  ...
  const links = buildLocationEditorLinks({ type: table as LocationType, locationId, canonicalId: canonicalId || undefined, sourceId, effectiveId, adminContext: isAdminContext, adminLocationId: adminLocationIdParam, isDemoMode, fromDemoCenter, searchParams });

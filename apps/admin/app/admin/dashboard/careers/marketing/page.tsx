      ...
      <div className="mx-auto max-w-[1400px] space-y-6">
        <header className="rounded-3xl border border-white/10 bg-[#120d0b] p-6">
          ...
          <div className="mt-2 flex flex-wrap items-end justify-between gap-4">
            <div>
              <h1 className="text-3xl font-black">Marketing Hiring Track</h1>
              <p className="mt-2 max-w-3xl text-sm text-white/55">
                Portfolio reviews, content tests, campus ambassador, creator, paid, and educational internship queues.
              </p>
            </div>

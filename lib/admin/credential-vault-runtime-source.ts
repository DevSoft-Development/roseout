...
const RUNTIME_ENV_MAP: RuntimeEnvMap = {
  ...
  microsoft: { tenantId: ["AZURE_TENANT_ID", "MICROSOFT_TENANT_ID"], clientId: ["AZURE_CLIENT_ID", "MICROSOFT_CLIENT_ID"], clientSecret: ["AZURE_CLIENT_SECRET", "MICROSOFT_CLIENT_SECRET"] },
  ...
  meta: { appId: ["META_APP_ID", "FACEBOOK_APP_ID"], appSecret: ["META_APP_SECRET", "FACEBOOK_APP_SECRET"], accessToken: ["META_ACCESS_TOKEN", "FACEBOOK_ACCESS_TOKEN"] },

...
('Try your own search prompt','natural_search','user','high','/create?betaTask=custom-prompt','custom',null,true,true,'Test My Prompt',5,'Type a real search you would naturally use on TheOutHaven. It can be for a date, birthday, family outing, girls outing, dinner, brunch, lounge, spa, activity, walking-distance pairing, or something nearby. After the search, tell us if the results were accurate and fast.','active'),

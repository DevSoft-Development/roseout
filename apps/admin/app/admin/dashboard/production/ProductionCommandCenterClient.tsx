      ...
      <header className="rounded-[2rem] border border-white/10 bg-[#0b0b0c]/95 p-5 shadow-2xl shadow-black/40">
        <div className="flex flex-col justify-between gap-4 lg:flex-row lg:items-center">
          <div>
            ...
            <p className="mt-2 text-sm text-white/65">A launch checklist with safe gate tests. Use it to track what is tested, what is broken, and which PR fixes each blocker.</p>
          </div>

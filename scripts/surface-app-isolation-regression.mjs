...
const enterpriseMarketingContentNewPage = read("apps/admin/app/admin/dashboard/marketing/content/new/page.tsx");
...
for (const [label, source] of [
  ...
  ["Create Marketing Content", enterpriseMarketingContentNewPage],

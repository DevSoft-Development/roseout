...
requireText('SNAPSHOT_PARAMETER: /theouthaven/production/web-surfaces/dns-cutover-last-snapshot', 'The pre-cutover DNS state must be saved for rollback.');
...
requireText('Remove temporary cutover permissions', 'Temporary Route 53/SSM permissions must always be cleaned up.');
requireText('TheOutHavenWebSurfaceDnsCutoverBootstrap', 'Cutover IAM bootstrap must remain isolated from unrelated policies.');

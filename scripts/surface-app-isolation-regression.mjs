...
const enterpriseBillingPage = read("apps/admin/app/admin/dashboard/billing/page.tsx");
const enterpriseCampaignsPage = read("apps/admin/app/admin/dashboard/campaigns/page.tsx");
const enterpriseRolesPage = read("apps/admin/app/admin/dashboard/roles/page.tsx");
const enterpriseSeoPage = read("apps/admin/app/admin/dashboard/seo/page.tsx");
const enterpriseSmsPage = read("apps/admin/app/admin/dashboard/sms/page.tsx");
const enterprisePlansPage = read("apps/admin/app/admin/dashboard/plans/page.tsx");

for (const [label, source] of [
  ["Billing", enterpriseBillingPage],
  ["Campaigns", enterpriseCampaignsPage],
  ["Roles", enterpriseRolesPage],
  ["SEO", enterpriseSeoPage],
  ["SMS", enterpriseSmsPage],
  ["Plans", enterprisePlansPage],
]) {
  for (const marker of ["AdminPageShell", "AdminPageHeader"]) {
    if (!source.includes(marker)) {
      throw new Error(`${label} must preserve shared enterprise Admin shell marker: ${marker}`);
...
const enterpriseSeoToolsPage = read("apps/admin/app/admin/dashboard/seo-tools/page.tsx");
const enterpriseEventsPage = read("apps/admin/app/admin/dashboard/events/page.tsx");
const enterpriseMarketingOpportunitiesPage = read("apps/admin/app/admin/dashboard/marketing/opportunities/page.tsx");
const enterpriseNewMarketingContentPage = read("apps/admin/app/admin/dashboard/marketing/content/new/page.tsx");
const enterpriseMailingBatchDetailPage = read("apps/admin/app/admin/dashboard/operations/mailing-batches/[id]/page.tsx");
for (const [label, source] of [
  ["SEO Tools", enterpriseSeoToolsPage],
  ["Events", enterpriseEventsPage],
  ["Marketing Opportunities", enterpriseMarketingOpportunitiesPage],
  ["Create Marketing Content", enterpriseNewMarketingContentPage],
  ["Mailing Batch Detail", enterpriseMailingBatchDetailPage],
]) {
  for (const marker of ["AdminPageShell", "AdminPageHeader"]) {
    if (!source.includes(marker)) {
      throw new Error(`${label} must preserve shared enterprise Admin shell marker: ${marker}`);
...
const enterpriseCareersPage = read("apps/admin/app/admin/dashboard/careers/page.tsx");
const enterpriseCareersJobsPage = read("apps/admin/app/admin/dashboard/careers/jobs/page.tsx");
const enterpriseCareersApplicationsPage = read("apps/admin/app/admin/dashboard/careers/applications/page.tsx");
const enterpriseCommunityPage = read("apps/admin/app/admin/dashboard/marketing/community/page.tsx");
const enterpriseGrowthPage = read("apps/admin/app/admin/dashboard/marketing/growth/page.tsx");
const enterpriseSocialManagerPage = read("apps/admin/app/admin/dashboard/marketing/social-manager/page.tsx");
for (const [label, source] of [
  ["Careers", enterpriseCareersPage],
  ["Careers Jobs", enterpriseCareersJobsPage],
  ["Careers Applications", enterpriseCareersApplicationsPage],
  ["Marketing Community", enterpriseCommunityPage],
  ["Marketing Growth", enterpriseGrowthPage],
  ["Social Manager", enterpriseSocialManagerPage],
]) {
  for (const marker of ["AdminPageShell", "AdminPageHeader"]) {
    if (!source.includes(marker)) {
      throw new Error(`${label} must preserve shared enterprise Admin shell marker: ${marker}`);
...
const finalEnterpriseAdminConsistencyPages = [
  ...
  ["Claim QR Codes", read("apps/admin/app/admin/dashboard/claim-qrs/page.tsx")],
  ["Sponsored Promotions", read("apps/admin/app/admin/dashboard/marketing/promotions/page.tsx")],
];
for (const [label, source] of finalEnterpriseAdminConsistencyPages) {
  for (const marker of ["AdminPageShell", "AdminPageHeader"]) {
    if (!source.includes(marker)) {
      throw new Error(`${label} must preserve shared enterprise Admin shell marker: ${marker}`);
    }

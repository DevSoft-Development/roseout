...
export const adminNavSections: readonly AdminNavSection[] = [
  ...
  { label: "Marketing", icon: Megaphone, items: [
    ...
    { label: "Ideas", href: "/admin/dashboard/marketing/ideas", icon: Lightbulb, permission: "marketing" },
    { label: "Media", href: "/admin/dashboard/marketing/media", icon: Image, permission: "marketing" },
    { label: "Creators", href: "/admin/dashboard/marketing/creators", icon: Users, permission: "marketing" },
    { label: "Approvals", href: "/admin/dashboard/marketing/approvals", icon: ClipboardCheck, permission: "marketing" },
    { label: "Analytics", href: "/admin/dashboard/marketing/analytics", icon: BarChart3, permission: "marketing" },

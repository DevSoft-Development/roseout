...
export default function BetaPage() {
  return <main className="min-h-screen bg-[#090706] px-4 py-10 text-white"><div className="mx-auto max-w-6xl space-y-8">
    <section className="rounded-[2rem] border border-white/10 bg-[radial-gradient(circle_at_top_left,rgba(225,29,72,.2),transparent_32%),linear-gradient(135deg,#170b0b,#090706_60%,#151010)] p-8 md:p-12">

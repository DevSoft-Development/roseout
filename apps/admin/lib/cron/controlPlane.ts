import cronRegistry from "./manifests/cron-jobs.json";
import awsActivationManifest from "./manifests/aws-activation.json";
import awsScheduleManifest from "./manifests/aws-schedules.json";
import vercelConfig from "./manifests/vercel.json";

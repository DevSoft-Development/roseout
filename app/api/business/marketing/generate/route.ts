...
export async function POST(request: Request){
  ...
  const ctx=await resolveEditableLocationContext({userId:user.id,userEmail:user.email??null,locationId:body.locationId,adminLocationId:body.adminLocationId,demoLocationId:body.demoLocationId,sourceId:body.sourceId,type:body.type,demo:body.demo===true||body.demo==="1",fromDemoCenter:body.fromDemoCenter===true||body.fromDemoCenter==="1"});
